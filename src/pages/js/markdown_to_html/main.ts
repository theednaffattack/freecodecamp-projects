let input = document.querySelector<HTMLTextAreaElement>("#markdown-input");
let htmlOutput = document.querySelector<HTMLTextAreaElement>("#html-output");
let htmlPreview = document.querySelector<HTMLDivElement>("#preview");
